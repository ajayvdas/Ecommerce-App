      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                        ...
                        <div className="p-8 lg:p-12 flex flex-col justify-center">
                          ...
                          <div className="mt-auto">
                            <div className="text-sm text-gray-500 mb-2">Recent Purchase:</div>
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-6 bg-white/90 hover:bg-white shadow-lg border-0 w-12 h-12"
            onClick={goToPrev}
          >
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 bg-white/90 hover:bg-white shadow-lg border-0 w-12 h-12"
            onClick={goToNext}
          >
