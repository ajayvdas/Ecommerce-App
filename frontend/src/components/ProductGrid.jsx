            ...
            {filteredProducts && filteredProducts.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-7xl mx-auto">
                    {filteredProducts.map((product) => (
                        ...
                        >
                            <Card className="w-full h-full overflow-hidden border-0 shadow-md hover:shadow-2xl transition-all duration-300 bg-white dark:bg-gray-800 max-w-sm mx-auto">
                                    ...
                                    <CardContent className="p-0 relative h-full flex flex-col">
                                        <div className="relative overflow-hidden">
                                            <img
                                                src={product.image}
                                                alt={product.name}
                                                className="w-full h-48 sm:h-52 md:h-56 lg:h-60 xl:h-64 object-cover transition-transform duration-500 group-hover:scale-110"
                                                loading="lazy"
                                            />
                ...
                <div className="flex flex-col items-center justify-center py-16 md:py-24 text-center">
                    <div className="mb-6">
                        <svg className="w-16 h-16 md:w-20 md:h-20 text-gray-300 dark:text-gray-600 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
