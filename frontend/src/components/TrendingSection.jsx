...
export default function TrendingSection({ onAddToWishlist, isAdding, onAddToCart,topProducts }) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <div className="inline-flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight">TRENDING NOW</h2>
                </div>
